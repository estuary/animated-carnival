...
mod test {
    ...
    async fn test_cases() {
        ...
        p2 as (
          ...
          -- Success: no-op that does not update write => read capability.
          ...
          -- Error: invalid claims (requested prefix is not a prefix).
          ('aa00000000000000', '11111111-1111-1111-1111-111111111111', '{"requestedPrefix":"one/two/three"}'),
          -- Error: invalid claims (wrong schema).
          ('aa00000000000000', '11111111-1111-1111-1111-111111111111', '{"in":"valid"}'),
        ...
        [
          ...
          },
          {
            ...
            "did": "aa:00:00:00:00:00:00:00",
            "status": {
              "error": "requested_prefix.: one/two/three doesn't match pattern ([\\p{Letter}\\p{Digit}\\-_\\.]+/)* (unmatched portion is: three)",
              "type": "invalidClaims"
            }
          },
          {
            ...
            "did": "aa:00:00:00:00:00:00:00",
            "status": {
              "error": "unknown field `in`, expected `requestedPrefix` at line 1 column 5",
              "type": "invalidClaims"
            }
          },
          {
          ...
          },
          {
            ...
            "status": {
              "error": "granted_prefix.: Not/A/Prefix! doesn't match pattern ([\\p{Letter}\\p{Digit}\\-_\\.]+/)* (unmatched portion is: Prefix!)",
              "type": "invalidDirective"
            }
          }
        ]
